...
public class Search_Contacts : MonoBehaviour
{
    ...
    public void search_contact(string s_key)
    {
        ...
        {
            this.app.carrot.show_msg(this.app.carrot.lang.Val("search","Search"), this.app.carrot.lang.Val("search_key_error","Search keywords cannot be empty"), Msg_Icon.Alert);
        }
    }
    ...
    public void advanced_search()
    {
        ...
        box_search_advanced.set_title(this.app.carrot.lang.Val("advanced_search","Advanced Search"));
        ...
        item_name.set_title(this.app.carrot.lang.Val("user_name","Name"));
        ...
        item_phone.set_title(this.app.carrot.lang.Val("user_phone","Phone"));
        ...
        item_sex.check_type();
        item_sex.set_title(this.app.carrot.lang.Val("user_sex","gender"));
        item_sex.set_tip("Search by gender");
        item_sex.dropdown_val.ClearOptions();
        item_sex.dropdown_val.options.Add(new Dropdown.OptionData() { text = this.app.carrot.lang.Val("user_sex_no", "No select") });
        item_sex.dropdown_val.options.Add(new Dropdown.OptionData() { text = this.app.carrot.lang.Val("user_sex_boy", "Male") });
        item_sex.dropdown_val.options.Add(new Dropdown.OptionData() { text = this.app.carrot.lang.Val("user_sex_girl", "Female") });
    ...
    private void Act_advanced_search()
    {
        ...
        {
            this.app.carrot.show_msg(this.app.carrot.lang.Val("advanced_search", "Advanced Search"), this.app.carrot.lang.Val("search_key_error", "Search keywords cannot be empty"), Msg_Icon.Alert);
            return;
        }
    ...
    private void Act_advanced_search_done(string s_data)
    {
        ...
        else
        {
            ...
            {
                this.app.carrot.show_msg(this.app.carrot.lang.Val("advanced_search", "Advanced Search"), this.app.carrot.lang.Val("list_none_tip", "There are no items in the list"), Msg_Icon.Alert);
            }
    ...
    private void Act_advanced_search_fail(string s_error)
    {
        ...
        if (this.box_search_advanced != null) this.box_search_advanced.close();
        this.app.carrot.show_msg(this.app.carrot.lang.Val("advanced_search", "Advanced Search"),s_error, Msg_Icon.Error);
    }
}
